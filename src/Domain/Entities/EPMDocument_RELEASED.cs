...
public class EPMDocument_RELEASED
{
	...
	public EPMDocument_RELEASED(long ent_ID, long ePMDocID, string stateDegeri, long idA3masterReference, string cadName, string name, string docNumber)
	{
		Ent_ID = ent_ID;
		EPMDocID = ePMDocID;
