...
public class WTPartAlternateLinkRemovedSentEntegration
{
	...
	public WTPartAlternateLinkRemovedSentEntegration()
	{
		LogDate = DateTime.Now;
		EntegrasyonDurum = 0;
	}

	public WTPartAlternateLinkRemovedSentEntegration(int logID, string anaParcaState, long anaParcaPartID, long anaParcaPartMasterID,
