...
public class WTPartAlternateLinkRemovedLogEntegration
{
	...
	public WTPartAlternateLinkRemovedLogEntegration()
	{
		LogDate = DateTime.Now;
		EntegrasyonDurum = 0;
	}

	public WTPartAlternateLinkRemovedLogEntegration(int logID, string anaParcaState, long anaParcaPartID, long anaParcaPartMasterID,
