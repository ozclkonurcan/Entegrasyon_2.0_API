...
public class WTPartAlternateLinkRemovedErrorEntegration : RetryableEntity
{
	...
	public WTPartAlternateLinkRemovedErrorEntegration()
	{
		LogDate = DateTime.Now;
		EntegrasyonDurum = 0;
	}

	public WTPartAlternateLinkRemovedErrorEntegration(int logID, string anaParcaState, long anaParcaPartID, long anaParcaPartMasterID,
