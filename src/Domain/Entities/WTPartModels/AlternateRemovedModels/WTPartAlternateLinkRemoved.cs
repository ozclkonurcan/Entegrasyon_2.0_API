...
public class WTPartAlternateLinkRemoved
{
	...
	public WTPartAlternateLinkRemoved()
	{
		LogDate = DateTime.Now;
		EntegrasyonDurum = 0;
	}

	public WTPartAlternateLinkRemoved(int logID, string anaParcaState, long anaParcaPartID, long anaParcaPartMasterID,
