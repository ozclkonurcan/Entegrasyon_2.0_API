...
public class WTPartAlternateLinkSentEntegration
{
	...
	public WTPartAlternateLinkSentEntegration()
	{
		LogDate = DateTime.Now;
		EntegrasyonDurum = 0;
	}

	public WTPartAlternateLinkSentEntegration(int logID, string anaParcaState, long anaParcaPartID, long anaParcaPartMasterID,
