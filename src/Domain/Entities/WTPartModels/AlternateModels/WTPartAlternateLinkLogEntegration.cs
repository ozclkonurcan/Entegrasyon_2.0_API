...
public class WTPartAlternateLinkLogEntegration
{
	...
	public WTPartAlternateLinkLogEntegration()
	{
		LogDate = DateTime.Now;
		EntegrasyonDurum = 0;
	}

	public WTPartAlternateLinkLogEntegration(int logID, string anaParcaState, long anaParcaPartID, long anaParcaPartMasterID,
