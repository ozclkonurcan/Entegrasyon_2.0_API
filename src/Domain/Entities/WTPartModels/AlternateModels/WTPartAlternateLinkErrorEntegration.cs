...
public class WTPartAlternateLinkErrorEntegration : RetryableEntity
{
	...
	public WTPartAlternateLinkErrorEntegration()
	{
		LogDate = DateTime.Now;
		EntegrasyonDurum = 0;
	}

	public WTPartAlternateLinkErrorEntegration(int logID, string anaParcaState, long anaParcaPartID, long anaParcaPartMasterID,
