...
public class WTPartAlternateLinkRemovedLogsConfiguration : IEntityTypeConfiguration<WTPartAlternateLinkRemovedLogEntegration>
{
	public void Configure(EntityTypeBuilder<WTPartAlternateLinkRemovedLogEntegration> builder)
	{
		builder.ToTable("Des2_WTPart_AlternateLinkRemoved_Log").HasKey(b => b.LogID);
		...
		builder.HasIndex(
			...
			name: "UK_WTPartAlternateLinkRemoved_Log_AnaParca_MuadilParca"
		).IsUnique();
	}
}
