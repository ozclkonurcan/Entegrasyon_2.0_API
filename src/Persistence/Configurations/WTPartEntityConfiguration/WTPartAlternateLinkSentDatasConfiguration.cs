...
public class WTPartAlternateLinkSentDatasConfiguration : IEntityTypeConfiguration<WTPartAlternateLinkSentEntegration>
{
	public void Configure(EntityTypeBuilder<WTPartAlternateLinkSentEntegration> builder)
	{
		builder.ToTable("Des2_WTPart_AlternateLink_Sent").HasKey(b => b.LogID);
		...
		builder.HasIndex(
			...
			name: "UK_WTPartAlternateLink_Sent_AnaParca_MuadilParca"
		).IsUnique();
	}
}