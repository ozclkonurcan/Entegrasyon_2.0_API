...
public class WTPartAlternateLinkErrorConfiguration : IEntityTypeConfiguration<WTPartAlternateLinkErrorEntegration>
{
	public void Configure(EntityTypeBuilder<WTPartAlternateLinkErrorEntegration> builder)
	{
		builder.ToTable("Des2_WTPart_AlternateLink_Error").HasKey(b => b.LogID);

		// Trigger olduğunu belirt
		builder.ToTable(tb => tb.HasTrigger("WTPartAlternateError_Trigger"));
		...
		builder.HasIndex(
			...
			name: "UK_WTPartAlternateLink_Error_AnaParca_MuadilParca"
		).IsUnique();
	}
}