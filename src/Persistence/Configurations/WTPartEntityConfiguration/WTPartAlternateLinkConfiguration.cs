...
public class WTPartAlternateLinkConfiguration : IEntityTypeConfiguration<WTPartAlternateLinkEntegration>
{
	public void Configure(EntityTypeBuilder<WTPartAlternateLinkEntegration> builder)
	{
		builder.ToTable("Des2_WTPart_AlternateLink").HasKey(b => b.LogID);
		...
		builder.HasIndex(
			...
			name: "UK_WTPartAlternateLink_AnaParca_MuadilParca"
		).IsUnique();
	}
}