...
public class WTPartAlternateLinkLogsConfiguration : IEntityTypeConfiguration<WTPartAlternateLinkLogEntegration>
{
	public void Configure(EntityTypeBuilder<WTPartAlternateLinkLogEntegration> builder)
	{
		builder.ToTable("Des2_WTPart_AlternateLink_Log").HasKey(b => b.LogID);
		...
		builder.HasIndex(
			...
			name: "UK_WTPartAlternateLink_Log_AnaParca_MuadilParca"
		).IsUnique();
	}
}
