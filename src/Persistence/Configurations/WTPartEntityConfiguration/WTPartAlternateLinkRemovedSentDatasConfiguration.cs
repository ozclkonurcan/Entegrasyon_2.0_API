...
public class WTPartAlternateLinkRemovedSentDatasConfiguration : IEntityTypeConfiguration<WTPartAlternateLinkRemovedSentEntegration>
{
	public void Configure(EntityTypeBuilder<WTPartAlternateLinkRemovedSentEntegration> builder)
	{
		builder.ToTable("Des2_WTPart_AlternateLinkRemoved_Sent").HasKey(b => b.LogID);
		...
		builder.HasIndex(
			...
			name: "UK_WTPartAlternateLinkRemoved_Sent_AnaParca_MuadilParca"
		).IsUnique();
	}
}
